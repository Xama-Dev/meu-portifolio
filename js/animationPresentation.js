...
conteinerContatos.classList.add('showContent')
containerRedesSociais.classList.add('showContent')

conteinerContatos.setAttribute('style', 'margin-left: 20%')
containerRedesSociais.setAttribute('style', 'margin-right: 20%') 